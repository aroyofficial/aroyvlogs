document.addEventListener('DOMContentLoaded',()=>{
  const startPujaAudio=()=>{
    ...
    if(!audio){audio=document.createElement('audio');audio.id='durga-puja-bgm';audio.src='Durga_Puja_BGM.mp3';audio.loop=true;audio.preload='auto';audio.setAttribute('aria-hidden','true');audio.style.display='none';document.body.appendChild(audio);}
    audio.play().catch(()=>{});
    return audio;
  };
